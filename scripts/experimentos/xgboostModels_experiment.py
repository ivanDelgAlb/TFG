...
def create_model_qubits(machine_name):
    ...
    dataset = pd.read_csv('scripts/experimentos/dataframe_experiment_qubit_' + formated_name + '.csv', names=columns)
...
def create_model_gates(machine_name):
    ...
    dataset = pd.read_csv('scripts/experimentos/dataframe_experiment_gate_' + formated_name + '.csv', names=columns)
    dataset = dataset[columns]
    ...
    file = f'scripts/experimentos/experiment_xgboost_gates_{formated_name}.model'
    final_model.save_model(file)
    print("Model created")
